...
import com.fedex.ics.jpa.DetermineImporterRepository;

@Component
public class DetermineImporterWorker {
  
  private static final Log logger = LogFactory.getLog(DetermineImporterWorker.class);
  @Autowired
  private DetermineImporterRepository repo;  
